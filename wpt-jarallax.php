...
const WPT_JARALLAX_VERSION = '2.1.3';
...
function wpt_require_jarallax() {
   ...
   if (!is_admin() && is_null($wpt_has_jarallax_been_required)) {
      ...
      wp_enqueue_script('jarallax', $base_url . 'jarallax.min.js', null, WPT_JARALLAX_VERSION, true);
      wp_enqueue_style('jarallaxcss', $base_url . 'jarallax.css', null, WPT_JARALLAX_VERSION);

      wp_enqueue_script('wpt-jarallax', $base_url . 'wpt-jarallax.js', array('jarallax'), $version, true);
